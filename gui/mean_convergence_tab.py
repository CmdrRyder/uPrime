...
class MeanVelocityTab(PickerMixin, ComparisonMixin, QWidget):
    ...
    def _build_manual_group(self):
        ...
        self.manual_coord_widget.setVisible(False)
        self.btn_manual_plot.setVisible(False)
        return grp
    ...
    def _run_line_profile(self, p0, p1):
        ...
        on the field axes then render the profile through _plot_profile()."""
    ...
    def _plot_profile(self):
        ...
        for key, field, color in [
            ...
            if chk is None or not chk.isChecked():
                continue
            vals, dist, xpts, ypts = self._profile_values(field, sel)
